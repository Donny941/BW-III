...
function Analytics() {
    return (
        <Card className='mt-2 mb-5'>
                ...
                <Row className='mt-3'>
                    <Col>
                        <div className='d-flex' style={{ width: "250px" }}>
                            ...
                            <div className='d-flex flex-column ms-2 mt-1'>
                                <a className='analyticsLink' href='#'>2 profile views</a>
                    ...
                    <Col>
                        <div className='d-flex' style={{ width: "250px" }}>
                            ...
                            <div className='d-flex flex-column ms-2 mt-1'>
                                <a className='analyticsLink' href='#'>10 post impressions</a>
                    ...
                    <Col>
                        <div className='d-flex' style={{ width: "250px" }}>
                            ...
                            <div className='d-flex flex-column ms-2 mt-1'>
                                <a className='analyticsLink' href='#'>20 appearance in search engines</a>
            ...
            <Button className='rounded-0 rounded-bottom btnCard' variant='light'>Show all analytics <ArrowRight /> </Button>
        </Card >
    );
}
